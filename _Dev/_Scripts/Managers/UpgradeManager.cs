...
public class UpgradeManager : MonoBehaviour
{
    ...
    public void PurchaseUpgrade(int upgradeNum)
    {
        ...
        if (PlayerPrefs.GetInt("Coin") >= price)
        {
            ...
            {
                case 0:
                    FindObjectOfType<Game.Player.StickManController>().ProcessIncrementalButton(Game.Incrementals.ButtonType.Year);
                    break;
                case 1:
                    FindObjectOfType<Game.Player.StickManController>().ProcessIncrementalButton(Game.Incrementals.ButtonType.Range);
                    break;
            }
        }
    }
